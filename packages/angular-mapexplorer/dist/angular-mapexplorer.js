(function (global, factory) {
	...
	(global.angularMapexplorer = factory(global.angular));
...
var merge$1 = interopDefault(index$3);
...
var httpplease = interopDefault(index$4);
...
function findSegments(agent) {
  ...
  return get$2(agent.url + '/segments' + makeQueryString(opts)).then(function (res) {
...
function getSegment(agent, linkHash) {
  return get$2(agent.url + '/segments/' + linkHash).then(function (res) {
    return segmentify(agent, res.body);
  });
}
...
function getMapIds(agent) {
  ...
  return get$2(agent.url + '/maps' + makeQueryString(opts)).then(function (res) {
    return res.body;
  });
}
...
function getAgent(url) {
  return get$2(url).then(function (res) {
    var agent = res.body;
...
var stringify = interopDefault(index$7);
  ...
  return {
    ...
    link: function link(scope, element) {
      scope.$watch('merklePath', function () {
        var merklePathTree = new MerklePathTree(element[0]);
        if (scope.merklePath) {
  ...
  return {
    ...
    link: function link(scope, element, attrs, controller) {
      ...
      var update = function update() {
        var options = _extends$1({}, defaultOptions, scope.options);
...
var AceConfigurationService = function () {
  function AceConfigurationService() {
    classCallCheck$1(this, AceConfigurationService);
  }

  createClass$1(AceConfigurationService, [{
    key: 'configure',
...
var ChainTreeBuilderService = function () {
  function ChainTreeBuilderService($q) {
    classCallCheck$1(this, ChainTreeBuilderService);

    this.$q = $q;
  }

  createClass$1(ChainTreeBuilderService, [{
    key: 'getBuilder',
...
var MapValidatorService = function () {
  function MapValidatorService($q) {
    classCallCheck$1(this, MapValidatorService);

    this.$q = $q;
  }

  createClass$1(MapValidatorService, [{
    key: 'validate',
...
var MapExplorer = function () {
  function MapExplorer($scope, AceConfigurationService) {
    ...
    classCallCheck$1(this, MapExplorer);
